...
class Test(unittest.TestCase):
	def test(self):
		...
		output = RunClient(host, ['pay', '--quantity', '1', '--toAddress', "swapbill2"])

		info = GetStateInfo(host)
		self.assertEqual(info['balances'], {"swapbill2": 1000001, "swapbill4":1999999})
		...
		info = GetStateInfo(host)
		self.assertEqual(info['balances'], {"swapbill2": 1000001, "swapbill4":1999999, "swapbill5": 400000000, "swapbill6": 100000000})

		output = RunClient(host, ['post_ltc_buy', '--quantity', '400000000', '--exchangeRate', "0.5"])

		info = GetStateInfo(host)
		#print(info)
		self.assertEqual(info['balances'], {"swapbill2": 1000001, "swapbill4": 1999999, "swapbill6": 100000000}) # swapbill5 entire balance moved in to buy offer

		RunClient(host, ['post_ltc_sell', '--quantity', '200000000', '--exchangeRate', "0.5"])

		info = GetStateInfo(host)
		self.assertEqual(info['balances'], {"swapbill2": 1000001, "swapbill4": 1999999, "swapbill9": 87500000}) # deposit of 12500000 moved in to sell offer
		...
		#print(output)
		#print('end get info')
		self.assertEqual(info['balances'], {"swapbill2": 1000001, "swapbill4": 1999999, "swapbill9": 87500000, "swapbill10": 212500000}) # seller gets deposit returned plus payment for ltc
	...
	def test_burn_and_pay(self):
		...
		info = GetStateInfo(host)
		thirdBurnTarget = payChange = "swapbill7"
