...
class Test(unittest.TestCase):
	def test(self):
		feeRequired = TransactionFee.CalculateRequired_FromSizeAndOutputs(100, [1000000, 1000000])
		self.assertEqual(feeRequired, 100000)
		feeRequired = TransactionFee.CalculateRequired_FromSizeAndOutputs(999, [1000000, 1000000])
		self.assertEqual(feeRequired, 100000)
		feeRequired = TransactionFee.CalculateRequired_FromSizeAndOutputs(999, [1000000, 10])
		self.assertEqual(feeRequired, 200000)
		feeRequired = TransactionFee.CalculateRequired_FromSizeAndOutputs(1000, [1000000, 1000000])
		self.assertEqual(feeRequired, 200000)
		feeRequired = TransactionFee.CalculateRequired_FromSizeAndOutputs(1000, [1000000, 1000000, 99999])
		self.assertEqual(feeRequired, 300000)
		...
		# (following added to fix missing missing coverage for transaction fee increase with dust outputs)
		# hack tx to put outputs under dust limit
		hackedTX = tx.replace('a08601', '9f8601')
		# and included whole query result in this case (not cut down)
		queryResult = {u'locktime': 0, u'version': 1, u'vin': [{u'sequence': 4294967295, u'scriptSig': {u'hex': u'48304502202d1cf412570325884ade168056d505116e84a91202ffb17b0fd850b5eba5314e022100d961f2aea05b3b4d1986c33fc746eded50d4eaf69c1e2f35422cd24a42d3b2590121039d60fe18a53ce505bfe0e696e746fee6dfeefa9cff223a147a45390eba3e8438', u'asm': u'304502202d1cf412570325884ade168056d505116e84a91202ffb17b0fd850b5eba5314e022100d961f2aea05b3b4d1986c33fc746eded50d4eaf69c1e2f35422cd24a42d3b25901 039d60fe18a53ce505bfe0e696e746fee6dfeefa9cff223a147a45390eba3e8438'}, u'vout': 2, u'txid': u'e7fdff3a47162a32a34f04ed68eceab75d5c9a1f6a7cfdac2c90e61f308a9b5b'}, {u'sequence': 4294967295, u'scriptSig': {u'hex': u'483045022100b2c50332ea7f1e2fb8aa6c8b16323d90920d87bfc35274f604f4ac6254180a6702200c71279244135acc0f418a2881e23017db989780a12941173e0a8cd52ccc8d11012103c6476b54cb9364e4d8e8177b9122d83ee7e61ae421f56b4e89a5ee0950be5bcc', u'asm': u'3045022100b2c50332ea7f1e2fb8aa6c8b16323d90920d87bfc35274f604f4ac6254180a6702200c71279244135acc0f418a2881e23017db989780a12941173e0a8cd52ccc8d1101 03c6476b54cb9364e4d8e8177b9122d83ee7e61ae421f56b4e89a5ee0950be5bcc'}, u'vout': 3, u'txid': u'66183db39ad2facfba742b454c78042322c1548c32037a2dc0b066436b3d21b1'}], u'vout': [{u'scriptPubKey': {u'reqSigs': 1, u'hex': u'76a91453574201050000000000ffffffff00000000000088ac', u'addresses': [u'mo7cukos6ZRkaKSKoQPY3TTjKFr5NDrv7c'], u'asm': u'OP_DUP OP_HASH160 53574201050000000000ffffffff000000000000 OP_EQUALVERIFY OP_CHECKSIG', u'type': u'pubkeyhash'}, u'value': 0.00099999, u'n': 0}, {u'scriptPubKey': {u'reqSigs': 1, u'hex': u'76a9140e53c3016712c1bf1fb246ee9c7f451248595e8f88ac', u'addresses': [u'mgpi6cBV9KQohQs9wGYZKRopgumRsKTgpF'], u'asm': u'OP_DUP OP_HASH160 0e53c3016712c1bf1fb246ee9c7f451248595e8f OP_EQUALVERIFY OP_CHECKSIG', u'type': u'pubkeyhash'}, u'value': 0.00099999, u'n': 1}, {u'scriptPubKey': {u'reqSigs': 1, u'hex': u'76a9148e6843080cf1588fb3cee215bd459818fac38c3c88ac', u'addresses': [u'mtVw9XubrZm4Mc2qA7DaxqZVQVJ3qEAmt9'], u'asm': u'OP_DUP OP_HASH160 8e6843080cf1588fb3cee215bd459818fac38c3c OP_EQUALVERIFY OP_CHECKSIG', u'type': u'pubkeyhash'}, u'value': 0.01179999, u'n': 2}, {u'scriptPubKey': {u'reqSigs': 1, u'hex': u'76a9141b12b098af6dfdf2ddf7491e0430e2c3c08e6c1288ac', u'addresses': [u'mhz6vpqWej1MffgnubKAENtvLHBHFmaaym'], u'asm': u'OP_DUP OP_HASH160 1b12b098af6dfdf2ddf7491e0430e2c3c08e6c12 OP_EQUALVERIFY OP_CHECKSIG', u'type': u'pubkeyhash'}, u'value': 0.00099999, u'n': 3}], u'txid': u'4f0fd7dbf778e4c5fcf8cd8e4cf941c8f8319ef0c7d5b2b97f73991c44152db2'}		
		rpcHost._d[('decoderawtransaction', hackedTX)] = queryResult
		
		feeRequired = TransactionFee.CalculateRequired(rpcHost, hackedTX)
		self.assertEqual(feeRequired, 400000)
		feePaid = TransactionFee.CalculatePaid(rpcHost, hackedTX)
		self.assertEqual(feePaid, 100003) # three outputs reduced by one increases fee paid 
		self.assertFalse(TransactionFee.TransactionFeeIsSufficient(rpcHost, hackedTX))
