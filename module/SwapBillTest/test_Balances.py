...
class Test(unittest.TestCase):
	...
	def test_single_forwarding(self):
		...
		balances.add('e', 5)
		balances.add('f', 6)
		self.assertRaises(KeyError, balances.consumeAndForward, ['a','b','c'], 'g')
		self.assertDictEqual(balances.balances, {'a': 1, 'b': 2, 'c': 3, 'e': 5, 'd': 4, 'f': 6})
	...
	def test_triple_forwarding_and_direct_refs(self):
		...
		balances.consumeAndForward(['f'], 'g')
		balances.removeRef('a')
		...
		self.assertDictEqual(balances.balances, {'g': 22})
