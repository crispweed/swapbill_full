...
class Test(unittest.TestCase):
	def test(self):
		txHex = ''
		tx, scriptPubKeys = DecodeTransaction.Decode(txHex)
		...
		self.assertEqual(tx.outputAmount(0), 36383979)
		...
		self.assertEqual(tx.outputAmount(2), 2000000)
		self.assertSequenceEqual(scriptPubKeys, ["76a914535750000000000000000000000000000000000088ac", "76a91433a6231c75e5a14cc3fb6989a49e1e2d4422053288ac", "76a91486ee1634949c9172183de8ce39ee078c4278cf0a88ac"])
		nonSwapBillTXHex = txHex.replace('5357500000', '5457500000')
		self.assertEqual(DecodeTransaction.Decode(nonSwapBillTXHex), (None, None))
